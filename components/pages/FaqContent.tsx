...
function getEnglishContent(): FaqStrings {
  ...
  return {
    ...
    q7: 'Can I use my payment for multiple searches?', a7: `It depends on the option chosen. A single query (${single}) covers one result. A Country Pass (${pass}) allows unlimited taxi and tipping queries for one country for 24 hours. A 10-query bundle (${bundle}) gives you 10 queries stored on your device, valid for 90 days across any city or country.`,
