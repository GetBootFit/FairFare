...
function getEnglishContent(): FaqStrings {
  ...
  return {
    ...
    q9: 'Can I get a refund?', a9: 'Due to the instant digital nature of the service, all sales are final once a result has been delivered. If you experienced a technical failure that prevented delivery, contact legal@hootling.com within 7 days and we will review your case.',
    ...
    <div className="space-y-6 pb-4">
      ...
      <div className="rounded-2xl bg-zinc-900 border border-zinc-800 p-4 space-y-2">
        ...
        <p className="text-sm text-zinc-400">
          {s.contact_body.split('legal@hootling.com')[0]}
          <a href="mailto:legal@hootling.com" className="text-purple-400 underline">legal@hootling.com</a>
          {s.contact_body.split('legal@hootling.com')[1]}
        </p>
      </div>
