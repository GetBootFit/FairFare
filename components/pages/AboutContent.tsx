...
function getEnglishContent(): AboutStrings {
  ...
  return {
    ...
    why_para3: `Hootling solves the taxi problem in under five seconds, from ${single}. Real meter rate data sourced from local taxi authorities. City-specific scam alerts tailored to your destination. 120+ cities, 50+ countries. No subscription. Built by travellers, for travellers.`,
    ...
    step3_desc: 'Pay once with card, Apple Pay, or Google Pay. No account, no subscription. Choose a single query or a Trip Pass for your whole trip.',
