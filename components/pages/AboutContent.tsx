...
function getEnglishContent(): AboutStrings {
  ...
  return {
    ...
    why_para3: 'Hootling solves the taxi problem in under five seconds, free. Real meter rate data sourced from local taxi authorities. City-specific scam alerts tailored to your destination. 160+ cities, 50+ countries. No account, no subscription. Built by travellers, for travellers.',
    ...
    step2_desc: "Route distance and travel time load instantly — confirm you've entered the right locations.",
    step3_title: 'Get your result — free',
    step3_desc: 'No payment required. Get the fare range, scam alerts, driver phrases, and full tipping guidance instantly.',
    ...
    claude_detail: 'Destination-specific scam alerts, tipping intelligence, and local driver phrases',
    stripe_detail: 'Secure payment infrastructure — used if premium features are introduced',
