...
function getEnglishContent(): BusinessStrings {
  return {
    ...
    why_para1: 'Every hotel booking, flight check-in, and trip itinerary has the same unanswered question: "How much will the taxi cost?" Hootling answers it — 120+ cities, real local meter rates, city-specific scam alerts, and tipping guidance for 50+ countries.',
    ...
    what_4: 'Local driver phrases in 14 languages',
