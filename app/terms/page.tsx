...
export const metadata: Metadata = {
  ...
  description: 'FairFare Terms of Service — the rules for using our taxi fare check and tipping guide service.',
}

const EFFECTIVE = '7 March 2026'
const CONTACT = 'legal@fairfare.app'
  ...
  return (
    <div className="space-y-6 pb-4">
      ...
      <p className="text-sm text-zinc-400 leading-relaxed">
        Please read these Terms of Service (&ldquo;Terms&rdquo;) carefully before using FairFare
      ...
      <Section title="1. Description of Service">
        <p>
          FairFare provides on-demand information about taxi fare estimates and tipping customs
      ...
      <Section title="5. Intellectual Property">
        <p>
          ...
          FairFare. You may not reproduce, distribute, or create derivative works from any part
      ...
      <Section title="7. Limitation of Liability">
        <p>
          To the fullest extent permitted by applicable law, FairFare and its operators shall
      ...
      <Section title="8. Indemnification">
        <p>
          You agree to indemnify and hold harmless FairFare and its operators from any claims,
