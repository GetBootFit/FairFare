      ...
      <Section title="2. When We Will Provide a Refund or Remedy">
        ...
        <ul className="mt-2 space-y-2 list-disc list-inside">
          ...
          <li>
            ...
            a Trip Pass for one country but the system issued an entitlement for a different
            country.
          </li>
          <li>
        ...
        <ul className="mt-1.5 space-y-1 list-disc list-inside">
          ...
          <li>You purchased the wrong product (e.g. Trip Pass for the wrong country)</li>
