...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/taxi/cities`,        lastModified: DATA_LAST_MODIFIED, changeFrequency: 'monthly', priority: 0.8,  alternates: hreflang(`${BASE}/taxi/cities`) },
    { url: `${BASE}/tipping/countries`,  lastModified: DATA_LAST_MODIFIED, changeFrequency: 'monthly', priority: 0.8,  alternates: hreflang(`${BASE}/tipping/countries`) },
    { url: `${BASE}/pricing`,            lastModified: now,               changeFrequency: 'monthly', priority: 0.75, alternates: hreflang(`${BASE}/pricing`) },
