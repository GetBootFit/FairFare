...
function buildJsonLd() {
  ...
  const faqs = [
    { q: 'How much does it cost?', a: `From ${p.single} USD per query. Single query: ${p.single}, Country Pass: ${p.pass}, 10-query bundle: ${p.bundle}.` },
    ...
    { q: 'Can I get a refund?', a: 'All sales final once result delivered. Tech failures reviewed — email legal@hootling.com.' },
