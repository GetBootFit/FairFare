...
function getFaqContent() {
  ...
  return {
    ...
    a7: `It depends on the option chosen. A single query (${single}) covers one result, valid for 8 hours. A Trip Pass (${pass}) gives you unlimited taxi and tipping checks for one country for 14 days — ideal for any trip up to 2 weeks.`,
