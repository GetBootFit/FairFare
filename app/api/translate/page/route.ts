...
function getFaqContent() {
  ...
  return {
    ...
    a7: `It depends on the option chosen. A single query (${single}) covers one result. A Country Pass (${pass}) allows unlimited taxi and tipping queries for one country for 24 hours. A 20-query bundle (${bundle}) gives you 20 queries stored on your device, valid for 90 days across any city or country.`,
